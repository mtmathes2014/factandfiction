<?php
     ...
     *
     * This template displays fact and fiction book store address input
     * page of the check out process
     *
...
<p><span class="error">*</span> indicates required information</p>
 <form name="addressForm"  id="addressForm" method="post" action="checkOutResult.php">
    <fieldset>
