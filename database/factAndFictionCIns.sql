-- load states
INSERT INTO factandfictionC.states(state_id, state_name)
VALUES ('AK', 'Alaska'),
  ('AL', 'Alabama'),
  ('AR', 'Arkansas'),
  ('AZ', 'Arizona'),
...
-- load authors
INSERT INTO factandfictionC.authors(au_id, au_lname, au_fname, phone, address, city, state_id, zip) VALUES 
...
-- load publishers
INSERT INTO factandfictionC.publishers(pub_id, pub_name, city, state_id, country) VALUES 
...
-- load titles
INSERT INTO factandfictionC.titles(title_id, title, pub_id, au_id, price, notes, pubdate)
...
-- load customer
INSERT INTO factandfictionC.customer( userName, password, firstName, lastName)
...
-- password pwd456#987 encrypted to $1$Yrb3wbZ/$tbZXV4lYGZd2Oiv3ZJS7B0 for hkari05 
-- password abf321#999 encrypted to $1$tuktkKsr$5uVTiZjdN.afDFLbLRpqU/  for annieb 
-- password ret637884#72 encrypted to $1$CvlRiFvV$sOcCBO7O3L/mNZP8wh4ml. for briang 
-- password asd765$ww32# encrypted to $1$ll1RK.z5$Y7llTsWy5yW.UC6lCJh.E. for rayfir 
-- password oier2315##7654 encrypted to $1$wD5QEkU4$sABnbxU3xAfAJvut8VEmi/ for carlos 
-- password a77559#7895 encrypted to $1$fVn5pwr4$UowvOcjvJjr3Z0ev19h70. for bmappli 
-- password c7653&79679 encrypted to $1$.ESE8ch4$aGYkGEa.Y94MldFEBLEix/ for chamtus 
-- password 7685drth8899 encrypted to $1$n.exIerv$MTUbJz3PAS.weCFcia5GX/ for awasonce

-- test userName fkrgr666 password frightnight firstName Freddy lastName Kruger regristration

-- load address type
INSERT INTO factandfictionC.addressType (at_addresstype, at_description)
values ('m', 'Mailing Address'), ('s', 'Billing Address'), ('b', 'Both');

-- load customer addresses
INSERT INTO factandfictionC.custAddress( c_id, ca_addressType, ca_streetaddress, ca_city, ca_state_id, ca_zip, ca_email, ca_phone)
VALUES ( 1, 'b', '123 Any St.', 'Any City', 'CA', '99966', 'hkari05@gmail.com', '818-555-1212'),
( 2, 'b', '16055 Tulsa St.', 'Granada Hills', 'CA', '91321', 'annib@gmail.com', '818-555-9992'),
( 3, 'b', '20741 Chase St.', 'Canoga Park', 'CA', '91311', 'bringiton@netzero.com', '818-555-1212'),
(4, 'b', '17481 Chatsworth St.', 'Granada Hills', 'CA', '91322', 'rfirwood@hotmail.com', '818-566-9792'),
 ( 5, 'b', '14639 Novice St.', 'Panarama City', 'CA', '91011', 'clossi@gmail.com', '818-375-4312'),
( 6, 'b', '16452 Index St.', 'Granada Hills', 'CA', '91322', 'bmaplib@gmail.com', '818-892-9725'),
( 7, 'b', '19612 Atwater Ave', 'Northridge', 'CA', '91324', 'chamsaf@netzero.com', '818-832-6325'),
( 8, 'b', '8307 Owens St.', 'Sunland', 'CA', '91361', 'aswood@hotmail.com', '626-766-7929');
